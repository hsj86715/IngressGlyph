...
public class BaseGlyphData {
    ...
    private void initTwoSequences() {
        ...
        mTwoSequences.put(CE_CIVILIZATION, new String[][]{{CE_CIVILIZATION, CE_CHAOS}});
        mTwoSequences.put(A_PURSUE, new String[][]{{A_PURSUE, H_XM}, {A_PURSUE, T_TRUTH}});
        mTwoSequences.put(A_SEPERATE, new String[][]{{A_SEPERATE, A_ATTACK_WAR}});
        mTwoSequences.put(A_CREATE, new String[][]{{A_CREATE, CE_DANGER}});
        mTwoSequences.put(CE_PATH, new String[][]{{CE_PATH, CE_BALANCE_PERFECTION}});
        mTwoSequences.put(A_DISCOVER, new String[][]{{A_DISCOVER, CE_SAFETY}, {A_DISCOVER, T_LIE},
                {A_DISCOVER, H_PORTAL}});
        mTwoSequences.put(A_ATTACK_WAR, new String[][]{{A_ATTACK_WAR, CE_CHAOS}, {A_ATTACK_WAR, CE_DIFFICULT}});
        mTwoSequences.put(A_LIBERATE, new String[][]{{A_LIBERATE, H_XM}});
        mTwoSequences.put(T_QUESTION, new String[][]{{T_QUESTION, A_ATTACK_WAR}});
        mTwoSequences.put(FD_LEAD, new String[][]{{FD_LEAD, H_ENLIGHTENMENT}});
        mTwoSequences.put(A_SEARCH, new String[][]{{A_SEARCH, CE_POTENTIAL}, {A_SEARCH, TS_PAST}});
        mTwoSequences.put(A_CAPTURE, new String[][]{{A_CAPTURE, H_PORTAL}});
        mTwoSequences.put(CE_PURE, new String[][]{{CE_PURE, T_TRUTH}, {CE_PURE, H_BODY}, {CE_PURE, H_HUMAN}});
        mTwoSequences.put(A_NOURISH, new String[][]{{A_NOURISH, A_JOURNEY}});
        mTwoSequences.put(CE_ALL, new String[][]{{CE_ALL, CE_CHAOS}});
        mTwoSequences.put(TS_OPEN_ALL, new String[][]{{TS_OPEN_ALL, T_TRUTH}});
    }

    private void initThreeSequences() {
        mThreeSequences = new LinkedHashMap<>();
        mThreeSequences.put(FD_GAIN, new String[][]{{FD_GAIN, CE_DIFFICULT, CE_BARRIER},
                {FD_GAIN, CE_CIVILIZATION, CE_HARMONY_PEACE}});
        mThreeSequences.put(A_DESTROY, new String[][]{{A_DESTROY, CE_WEAK, CE_CIVILIZATION},
                {A_DESTROY, T_DESTINY, CE_BARRIER}});
        mThreeSequences.put(CE_CIVILIZATION, new String[][]{{CE_CIVILIZATION, A_ATTACK_WAR, CE_CHAOS}});
        mThreeSequences.put(A_AVOID, new String[][]{{A_AVOID, T_DESTINY, T_LIE},
                {A_AVOID, CE_COMPLEX, CE_CONFLICT}});
        mThreeSequences.put(A_SEPERATE, new String[][]{{A_SEPERATE, TS_FUTURE, FD_EVOLUTION_SUCCESS}});
        mThreeSequences.put(CE_PATH, new String[][]{{CE_PATH, CE_HARMONY_PEACE, CE_DIFFICULT}});
        mThreeSequences.put(TS_AGAIN_REPEAT, new String[][]{{TS_AGAIN_REPEAT, A_JOURNEY, TS_DISTANCE_OUTSIDE}});
        mThreeSequences.put(A_DISCOVER, new String[][]{{A_DISCOVER, H_SHAPERS, T_LIE},
                {A_DISCOVER, CE_PURE, T_TRUTH}});
        mThreeSequences.put(CE_NATURE, new String[][]{{CE_NATURE, CE_PURE, A_DEFEND}});
        mThreeSequences.put(A_ATTACK_WAR, new String[][]{{A_ATTACK_WAR, A_CREATE, CE_DANGER},
                {A_ATTACK_WAR, A_DESTROY, TS_FUTURE}, {A_ATTACK_WAR, CE_DIFFICULT, TS_FUTURE},
                {A_ATTACK_WAR, H_SHAPERS, FD_EVOLUTION_SUCCESS}});
        mThreeSequences.put(A_LIBERATE, new String[][]{{A_LIBERATE, H_PORTAL, CE_POTENTIAL}});
        mThreeSequences.put(TS_NOT_INSIDE, new String[][]{{TS_NOT_INSIDE, H_MIND, TS_FUTURE}});
        mThreeSequences.put(T_FEAR, new String[][]{{T_FEAR, CE_CHAOS, H_XM}});
        mThreeSequences.put(A_CHANGE, new String[][]{{A_CHANGE, H_HUMAN, TS_FUTURE}});
        mThreeSequences.put(T_QUESTION, new String[][]{{T_QUESTION, H_SHAPERS, CE_CHAOS},
                {T_QUESTION, A_HIDE, T_TRUTH}, {T_QUESTION, CE_CONFLICT, T_DATA}});
        mThreeSequences.put(A_ESCAPE, new String[][]{{A_ESCAPE, CE_IMPURE, FD_EVOLUTION_SUCCESS}});
        mThreeSequences.put(CE_COMPLEX, new String[][]{{CE_COMPLEX, A_JOURNEY, TS_FUTURE}});
        mThreeSequences.put(FD_FOLLOW, new String[][]{{FD_FOLLOW, CE_PURE, A_JOURNEY}});
        mThreeSequences.put(FD_LEAD, new String[][]{{FD_LEAD, H_RESISTANCE_STRUGGLE, T_QUESTION}});
        mThreeSequences.put(A_REACT, new String[][]{{A_REACT, CE_IMPURE, CE_CIVILIZATION}});
        mThreeSequences.put(A_CAPTURE, new String[][]{{A_CAPTURE, H_SHAPERS, H_PORTAL}});
        mThreeSequences.put(A_JOURNEY, new String[][]{{A_JOURNEY, TS_NOT_INSIDE, H_SOUL}});
        mThreeSequences.put(FD_LOSE, new String[][]{{FD_LOSE, A_ATTACK_WAR, A_RETREAT}});
        mThreeSequences.put(FD_IMPROVE, new String[][]{{FD_IMPROVE, A_ADVANCE, TS_NOW_PRESENT},
                {FD_IMPROVE, H_HUMAN, H_SHAPERS}});
        mThreeSequences.put(TS_FUTURE, new String[][]{{TS_FUTURE, FD_EQUAL, TS_PAST}});
        mThreeSequences.put(A_TOGETHER, new String[][]{{A_TOGETHER, A_PURSUE, CE_SAFETY}});
        mThreeSequences.put(CE_HARM, new String[][]{{CE_HARM, CE_DANGER, A_AVOID}});
        mThreeSequences.put(CE_BALANCE_PERFECTION, new String[][]{{CE_BALANCE_PERFECTION, CE_PATH, CE_HARMONY_PEACE}});
        mThreeSequences.put(H_MIND, new String[][]{{H_MIND, TS_OPEN_ACCEPT, A_BREATHE_LIVE}});
        mThreeSequences.put(CE_ALL, new String[][]{{CE_ALL, H_XM, A_LIBERATE}});
        mThreeSequences.put(TS_OPEN_ALL, new String[][]{{TS_OPEN_ALL, H_PORTAL, FD_EVOLUTION_SUCCESS}});
        mThreeSequences.put(H_XM, new String[][]{{H_XM, A_NOURISH, CE_CIVILIZATION}});
        mThreeSequences.put(T_TRUTH, new String[][]{{T_TRUTH, A_NOURISH, H_SOUL}});
    }

    private void initFourSequences() {
        mFourSequences = new LinkedHashMap<>();
        mFourSequences.put(FD_GAIN, new String[][]{{FD_GAIN, H_PORTAL, A_ATTACK_WAR, CE_WEAK}});
        mFourSequences.put(TS_PAST, new String[][]{{TS_PAST, TS_AGAIN_REPEAT, TS_NOW_PRESENT, TS_AGAIN_REPEAT}});
        mFourSequences.put(A_DESTROY, new String[][]{{A_DESTROY, T_DESTINY, H_HUMAN, T_LIE},
                {A_DESTROY, CE_COMPLEX, H_SHAPERS, T_LIE}});
        mFourSequences.put(A_RESTRAINT, new String[][]{{A_RESTRAINT, CE_PATH, FD_GAIN, CE_HARMONY_PEACE},
                {A_RESTRAINT, T_FEAR, A_AVOID, CE_DANGER}});
        mFourSequences.put(A_BREATHE_LIVE, new String[][]{{A_BREATHE_LIVE, TS_AGAIN_REPEAT, A_JOURNEY,
                TS_AGAIN_REPEAT}, {A_BREATHE_LIVE, CE_NATURE, CE_BALANCE_PERFECTION, CE_HARMONY_PEACE}});
        mFourSequences.put(A_DEFEND, new String[][]{{A_DEFEND, T_MESSAGE, T_ANSWER, T_IDEA_THOUGHT}});
        mFourSequences.put(A_HELP, new String[][]{{A_HELP, FD_GAIN, A_CREATE, A_PURSUE}, {A_HELP,
                H_SHAPERS, A_CREATE, TS_FUTURE}});
        mFourSequences.put(A_AVOID, new String[][]{{A_AVOID, H_XM, T_MESSAGE, T_LIE}});
        mFourSequences.put(A_SEPERATE, new String[][]{{A_SEPERATE, CE_WEAK, T_IGNORE, T_TRUTH}});
        mFourSequences.put(T_FORGET, new String[][]{{T_FORGET, CE_CONFLICT, TS_OPEN_ACCEPT, A_ATTACK_WAR}});
        mFourSequences.put(A_CREATE, new String[][]{{A_CREATE, TS_DISTANCE_OUTSIDE, CE_IMPURE, CE_PATH},
                {A_CREATE, TS_FUTURE, TS_NOT_INSIDE, A_ATTACK_WAR}, {A_CREATE, TS_FUTURE, A_CHANGE, T_DESTINY}});
        mFourSequences.put(A_ADVANCE, new String[][]{{A_ADVANCE, CE_CIVILIZATION, TS_AGAIN_REPEAT, FD_FAILURE}});
        mFourSequences.put(CE_PATH, new String[][]{{CE_PATH, A_RESTRAINT, CE_STRONG, CE_SAFETY}});
        mFourSequences.put(FD_DETERIORATE, new String[][]{{FD_DETERIORATE, H_HUMAN, CE_WEAK, A_REBEL}});
        mFourSequences.put(T_COURAGE, new String[][]{{T_COURAGE, A_ATTACK_WAR, H_SHAPERS, TS_FUTURE}});
        mFourSequences.put(CE_STABILITY_STAY, new String[][]{{CE_STABILITY_STAY, A_TOGETHER, A_DEFEND, T_TRUTH}});
        mFourSequences.put(H_SHAPERS, new String[][]{{H_SHAPERS, A_SEE, CE_POTENTIAL, FD_EVOLUTION_SUCCESS},
                {H_SHAPERS, H_PORTAL, H_MIND, A_RESTRAINT}, {H_SHAPERS, TS_PAST, TS_NOW_PRESENT, TS_FUTURE},
                {H_SHAPERS, H_MIND, CE_COMPLEX, CE_HARMONY_PEACE}, {H_SHAPERS, CE_HAVE, CE_STRONG, CE_PATH},
                {H_SHAPERS, CE_CHAOS, CE_PURE, CE_HARM}, {H_SHAPERS, T_MESSAGE, TS_END, CE_CIVILIZATION}});
        mFourSequences.put(A_ATTACK_WAR, new String[][]{{A_ATTACK_WAR, CE_WEAK, H_SHAPERS, T_LIE},
                {A_ATTACK_WAR, H_RESISTANCE_STRUGGLE, A_PURSUE, H_ENLIGHTENMENT}, {A_ATTACK_WAR,
                H_ENLIGHTENMENT, A_PURSUE, H_RESISTANCE_STRUGGLE}});
        mFourSequences.put(CE_CHAOS, new String[][]{{CE_CHAOS, CE_BARRIER, H_SHAPERS, H_PORTAL}});
        mFourSequences.put(A_LIBERATE, new String[][]{{A_LIBERATE, H_XM, H_PORTAL, A_TOGETHER}});
        mFourSequences.put(A_SEE, new String[][]{{A_SEE, T_TRUTH, A_SEE, TS_FUTURE}});
        mFourSequences.put(FD_LESS, new String[][]{{FD_LESS, CE_CHAOS, FD_MORE, CE_STABILITY_STAY},
                {FD_LESS, T_TRUTH, FD_MORE, CE_CHAOS}, {FD_LESS, H_SOUL, FD_MORE, H_MIND}});
        mFourSequences.put(TS_NOT_INSIDE, new String[][]{{TS_NOT_INSIDE, H_MIND, A_JOURNEY, CE_BALANCE_PERFECTION}});
        mFourSequences.put(A_HIDE, new String[][]{{A_HIDE, CE_IMPURE, H_HUMAN, T_IDEA_THOUGHT}});
        mFourSequences.put(CE_SIMPLE, new String[][]{{CE_SIMPLE, CE_CIVILIZATION, CE_IMPURE, CE_WEAK},
                {CE_SIMPLE, T_TRUTH, A_BREATHE_LIVE, CE_NATURE}, {CE_SIMPLE, T_MESSAGE, CE_COMPLEX, T_IDEA_THOUGHT}});
        mFourSequences.put(A_CHANGE, new String[][]{{A_CHANGE, H_HUMAN, CE_POTENTIAL, A_USE},
                {A_CHANGE, TS_FUTURE, A_CAPTURE, T_DESTINY}, {A_CHANGE, H_BODY, FD_IMPROVE, H_HUMAN}});
        mFourSequences.put(T_QUESTION, new String[][]{{T_QUESTION, T_TRUTH, FD_GAIN, TS_FUTURE}});
        mFourSequences.put(A_ESCAPE, new String[][]{{A_ESCAPE, CE_SIMPLE, H_HUMAN, TS_FUTURE}});
        mFourSequences.put(CE_COMPLEX, new String[][]{{CE_COMPLEX, H_SHAPERS, CE_CIVILIZATION, CE_STRONG}});
        mFourSequences.put(CE_CLEAR, new String[][]{{CE_CLEAR, H_MIND, TS_OPEN_ACCEPT, H_MIND}});
        mFourSequences.put(FD_FOLLOW, new String[][]{{FD_FOLLOW, H_SHAPERS, H_PORTAL, T_MESSAGE}});
        mFourSequences.put(FD_LEAD, new String[][]{{FD_LEAD, A_PURSUE, A_REACT, A_DEFEND}});
        mFourSequences.put(T_CONTEMPLATE, new String[][]{{T_CONTEMPLATE, CE_COMPLEX, H_SHAPERS, T_TRUTH},
                {T_CONTEMPLATE, CE_COMPLEX, H_SHAPERS, CE_CIVILIZATION}, {T_CONTEMPLATE, H_SELF,
                H_SHAPERS, T_TRUTH}, {T_CONTEMPLATE, H_SELF, CE_PATH, T_TRUTH}});
        mFourSequences.put(A_SEARCH, new String[][]{{A_SEARCH, T_TRUTH, A_SAVE, CE_CIVILIZATION},
                {A_SEARCH, H_XM, A_SAVE, H_PORTAL}, {A_SEARCH, T_DATA, A_DISCOVER, CE_PATH}});
        mFourSequences.put(A_CAPTURE, new String[][]{{A_CAPTURE, T_FEAR, A_DISCOVER, T_COURAGE}});
        mFourSequences.put(A_JOURNEY, new String[][]{{A_JOURNEY, TS_NOT_INSIDE, FD_IMPROVE, H_SOUL}});
        mFourSequences.put(T_IGNORE, new String[][]{{T_IGNORE, H_HUMAN, CE_CHAOS, T_LIE}});
        mFourSequences.put(FD_LOSE, new String[][]{{FD_LOSE, CE_DANGER, FD_GAIN, CE_SAFETY}});
        mFourSequences.put(FD_IMPROVE, new String[][]{{FD_IMPROVE, H_BODY, A_PURSUE, A_JOURNEY},
                {FD_IMPROVE, H_BODY, H_MIND, H_SOUL}, {FD_IMPROVE, H_MIND, A_JOURNEY, TS_NOT_INSIDE}});
        mFourSequences.put(A_TOGETHER, new String[][]{{A_TOGETHER, A_DISCOVER, CE_HARMONY_PEACE, FD_EQUAL}});
        mFourSequences.put(H_RESISTANCE_STRUGGLE, new String[][]{{H_RESISTANCE_STRUGGLE, FD_IMPROVE,
                H_HUMAN, H_SOUL}, {H_RESISTANCE_STRUGGLE, A_DEFEND, H_SHAPERS, CE_DANGER}});
        mFourSequences.put(CE_BALANCE_PERFECTION, new String[][]{{CE_BALANCE_PERFECTION,
                CE_BALANCE_PERFECTION, CE_SAFETY, CE_ALL}});
        mFourSequences.put(H_HUMAN, new String[][]{{H_HUMAN, CE_HAVE, CE_IMPURE, CE_CIVILIZATION},
                {H_HUMAN, H_SOUL, CE_STRONG, CE_PURE}, {H_HUMAN, TS_PAST, TS_NOW_PRESENT, TS_FUTURE}});
        mFourSequences.put(A_NOURISH, new String[][]{{A_NOURISH, H_XM, A_CREATE, T_IDEA_THOUGHT}});
        mFourSequences.put(H_SOUL, new String[][]{{H_SOUL, A_REBEL, H_HUMAN, A_DIE}});
        mFourSequences.put(CE_ALL, new String[][]{{C_ALL, CE_CHAOS, TS_NOT_INSIDE, H_BODY}});
        mFourSequences.put(TS_CLOSE_ALL, new String[][]{{TS_CLOSE_ALL, TS_OPEN_ALL, A_DISCOVER, T_TRUTH}});
        mFourSequences.put(CE_STRONG, new String[][]{{CE_STRONG, T_IDEA_THOUGHT, A_PURSUE, T_TRUTH},
                {CE_STRONG, A_TOGETHER, A_AVOID, A_ATTACK_WAR}, {CE_STRONG, H_RESISTANCE_STRUGGLE,
                A_CAPTURE, H_PORTAL}});
        mFourSequences.put(H_XM, new String[][]{{H_XM, CE_HAVE, H_MIND, A_JOURNEY}, {H_XM, A_DIE,
                CE_CHAOS, A_BREATHE_LIVE}});
        mFourSequences.put(T_TRUTH, new String[][]{{T_TRUTH, T_IDEA_THOUGHT, A_DISCOVER, H_XM}});
        mFourSequences.put(H_PORTAL, new String[][]{{H_PORTAL, CE_HAVE, T_TRUTH, T_DATA}, {H_PORTAL,
                CE_POTENTIAL, A_CHANGE, TS_FUTURE}, {H_PORTAL, A_DIE, CE_CIVILIZATION, A_DIE},
                {H_PORTAL, A_CHANGE, CE_CIVILIZATION, TS_END}});
        mFourSequences.put(CE_HARMONY_PEACE, new String[][]{{CE_HARMONY_PEACE, CE_PATH, A_NOURISH, TS_NOW_PRESENT}});
    }

    private void initFiveSequences() {
        mFiveSequences = new LinkedHashMap<>();
        mFiveSequences.put(FD_GAIN, new String[][]{{FD_GAIN, T_TRUTH, TS_OPEN_ACCEPT, H_HUMAN, H_SOUL}});
        mFiveSequences.put(TS_OLD, new String[][]{{TS_OLD, CE_NATURE, FD_LESS, CE_STRONG, TS_NOW_PRESENT}});
        mFiveSequences.put(TS_PAST, new String[][]{{TS_PAST, CE_CHAOS, A_CREATE, TS_FUTURE, CE_HARMONY_PEACE},
                {TS_PAST, CE_PATH, A_CREATE, TS_FUTURE, A_JOURNEY}});
        mFiveSequences.put(A_DESTROY, new String[][]{{A_DESTROY, T_LIE, TS_NOT_INSIDE, FD_GAIN, H_SOUL},
                {A_DESTROY, CE_CIVILIZATION, TS_END, CE_CONFLICT, A_ATTACK_WAR}});
        mFiveSequences.put(A_BREATHE_LIVE, new String[][]{{A_BREATHE_LIVE, TS_NOT_INSIDE, H_XM,
                FD_LOSE, H_SELF}});
        mFiveSequences.put(A_DEFEND, new String[][]{{A_DEFEND, T_DESTINY, A_DEFEND, H_HUMAN, CE_CIVILIZATION},
        ...
        mFiveSequences.put(A_HELP, new String[][]{{A_HELP, H_ENLIGHTENMENT, A_CAPTURE, CE_ALL, H_PORTAL},
                {A_HELP, H_RESISTANCE_STRUGGLE, A_CAPTURE, CE_ALL, H_PORTAL}, {A_HELP, H_HUMAN,
                CE_CIVILIZATION, A_PURSUE, T_DESTINY}});
        mFiveSequences.put(A_PURSUE, new String[][]{{A_PURSUE, CE_PATH, TS_DISTANCE_OUTSIDE, H_SHAPERS,
                T_LIE}, {A_PURSUE, CE_CONFLICT, A_ATTACK_WAR, A_ADVANCE, CE_CHAOS}});
        mFiveSequences.put(CE_WEAK, new String[][]{{CE_WEAK, H_HUMAN, T_DESTINY, A_DESTROY, CE_CIVILIZATION}});
        mFiveSequences.put(A_AVOID, new String[][]{{A_AVOID, CE_CHAOS, A_RECHARGE_REPAIR, CE_POTENTIAL,
                A_ATTACK_WAR}, {A_AVOID, CE_BALANCE_PERFECTION, CE_STABILITY_STAY, H_HUMAN, H_SELF},
                {A_AVOID, CE_CHAOS, A_AVOID, H_SHAPERS, T_LIE}});
        mFiveSequences.put(A_REBEL, new String[][]{{A_REBEL, T_IDEA_THOUGHT, FD_EVOLUTION_SUCCESS,
                T_DESTINY, TS_NOW_PRESENT}});
        mFiveSequences.put(A_SEPERATE, new String[][]{{A_SEPERATE, H_MIND, H_BODY, A_DISCOVER,
                H_ENLIGHTENMENT}, {A_SEPERATE, T_TRUTH, T_LIE, H_SHAPERS, TS_FUTURE}});
        mFiveSequences.put(T_FORGET, new String[][]{{T_FORGET, TS_PAST, A_SEE, TS_NOW_PRESENT, CE_DANGER},
                {T_FORGET, A_ATTACK_WAR, A_SEE, TS_DISTANCE_OUTSIDE, CE_HARMONY_PEACE}});
        mFiveSequences.put(A_CREATE, new String[][]{{A_CREATE, CE_PURE, TS_FUTURE, TS_NOT_INSIDE,
                A_ATTACK_WAR}, {A_CREATE, CE_PURE, TS_FUTURE, H_HUMAN, CE_CIVILIZATION}, {A_CREATE,
                A_SEPERATE, CE_PATH, TS_END, A_JOURNEY}});
        mFiveSequences.put(A_ADVANCE, new String[][]{{A_ADVANCE, CE_CIVILIZATION, A_PURSUE, H_SHAPERS, CE_PATH}});
        mFiveSequences.put(TS_DISTANCE_OUTSIDE, new String[][]{{TS_DISTANCE_OUTSIDE, H_SELF, A_AVOID,
                H_HUMAN, T_LIE}});
        mFiveSequences.put(T_COURAGE, new String[][]{{T_COURAGE, A_ATTACK_WAR, H_SHAPERS, H_PORTAL, A_TOGETHER}});
        mFiveSequences.put(T_WANT, new String[][]{{T_WANT, T_TRUTH, A_PURSUE, CE_DIFFICULT, CE_PATH}});
        mFiveSequences.put(CE_STABILITY_STAY, new String[][]{{CE_STABILITY_STAY, CE_STRONG, A_TOGETHER,
                A_DEFEND, H_RESISTANCE_STRUGGLE}});
        mFiveSequences.put(H_SHAPERS, new String[][]{{H_SHAPERS, H_PORTAL, T_DATA, A_REACT, CE_CHAOS},
                {H_SHAPERS, H_PORTAL, T_MESSAGE, A_DESTROY, CE_CIVILIZATION}, {H_SHAPERS, T_WANT,
                H_HUMAN, H_MIND, TS_FUTURE}, {H_SHAPERS, FD_LEAD, H_HUMAN, CE_COMPLEX, A_JOURNEY}});
        mFiveSequences.put(CE_CHAOS, new String[][]{{CE_CHAOS, A_ATTACK_WAR, CE_CONFLICT, A_DISCOVER, CE_HARMONY_PEACE}});
        mFiveSequences.put(A_LIBERATE, new String[][]{{A_LIBERATE, H_PORTAL, A_LIBERATE, H_HUMAN, H_MIND}});
        mFiveSequences.put(TS_NOW_PRESENT, new String[][]{{TS_NOW_PRESENT, CE_CHAOS, A_CREATE,
                TS_FUTURE, CE_CIVILIZATION}});
        mFiveSequences.put(TS_NOT_INSIDE, new String[][]{{TS_NOT_INSIDE, H_MIND, TS_NOT_INSIDE,
                H_SOUL, CE_HARMONY_PEACE}});
        mFiveSequences.put(T_ANSWER, new String[][]{{T_ANSWER, T_QUESTION, A_DISCOVER, CE_DIFFICULT, T_TRUTH}});
        mFiveSequences.put(A_HIDE, new String[][]{{A_HIDE, H_RESISTANCE_STRUGGLE, A_ADVANCE,
                CE_STRONG, A_TOGETHER}});
        mFiveSequences.put(CE_SIMPLE, new String[][]{{CE_SIMPLE, T_TRUTH, H_SHAPERS, A_DESTROY, CE_CIVILIZATION},
                {CE_SIMPLE, TS_OLD, T_TRUTH, A_JOURNEY, TS_NOT_INSIDE}});
        mFiveSequences.put(FD_MORE, new String[][]{{FD_MORE, T_DATA, FD_GAIN, H_PORTAL, A_ADVANCE}});
        mFiveSequences.put(A_SAVE, new String[][]{{A_SAVE, H_HUMAN, CE_CIVILIZATION, A_DESTROY, H_PORTAL}});
        mFiveSequences.put(T_QUESTION, new String[][]{{T_QUESTION, FD_LESS, T_FORGET, CE_ALL, T_LIE}});
        mFiveSequences.put(A_ESCAPE, new String[][]{{A_ESCAPE, H_BODY, A_JOURNEY, TS_DISTANCE_OUTSIDE,
                TS_NOW_PRESENT}, {A_ESCAPE, H_BODY, H_MIND, H_SELF, T_WANT}});
        mFiveSequences.put(CE_CLEAR, new String[][]{{CE_CLEAR, H_MIND, A_LIBERATE, CE_BARRIER, H_BODY}});
        mFiveSequences.put(T_CONTEMPLATE, new String[][]{{T_CONTEMPLATE, TS_FUTURE, TS_NOT_INSIDE,
                H_SHAPERS, CE_PATH}, {T_CONTEMPLATE, A_RESTRAINT, A_DISCOVER, FD_MORE, T_COURAGE}});
        mFiveSequences.put(A_USE, new String[][]{{A_USE, A_RESTRAINT, FD_FOLLOW, CE_EASY, CE_PATH},
                {A_USE, H_MIND, A_USE, T_COURAGE, A_CHANGE}});
        mFiveSequences.put(A_SEARCH, new String[][]{{A_SEARCH, T_DESTINY, A_CREATE, CE_PURE, TS_FUTURE}});
        mFiveSequences.put(CE_EASY, new String[][]{{CE_EASY, CE_PATH, TS_FUTURE, FD_FOLLOW, H_SHAPERS}});
        mFiveSequences.put(A_REACT, new String[][]{{A_REACT, A_REBEL, T_QUESTION, H_SHAPERS, T_LIE}});
        mFiveSequences.put(A_CAPTURE, new String[][]{{A_CAPTURE, H_PORTAL, A_DEFEND, H_PORTAL, T_COURAGE}});
        mFiveSequences.put(FD_LOSE, new String[][]{{FD_LOSE, H_SHAPERS, T_MESSAGE, FD_GAIN, CE_CHAOS}});
        mFiveSequences.put(CE_PURE, new String[][]{{CE_PURE, H_HUMAN, FD_FAILURE, TS_NOW_PRESENT, CE_CHAOS}});
        mFiveSequences.put(CE_IMPERFECT, new String[][]{{CE_IMPERFECT, H_XM, T_MESSAGE, H_HUMAN, CE_CHAOS},
                {CE_IMPERFECT, T_TRUTH, TS_OPEN_ACCEPT, CE_COMPLEX, T_ANSWER}});
        mFiveSequences.put(H_HUMAN, new String[][]{{H_HUMAN, H_SHAPERS, A_TOGETHER, A_CREATE, T_DESTINY},
                {H_HUMAN, TS_NOT_INSIDE, A_TOGETHER, CE_CIVILIZATION, FD_DETERIORATE}});
        mFiveSequences.put(A_RECHARGE_REPAIR, new String[][]{{A_RECHARGE_REPAIR, TS_NOW_PRESENT,
                A_RECHARGE_REPAIR, H_HUMAN, H_SOUL}, {A_RECHARGE_REPAIR, H_SOUL, FD_LESS, H_HUMAN, CE_HARM}});
        mFiveSequences.put(TS_CLOSE_ALL, new String[][]{{TS_CLOSE_ALL, T_IDEA_THOUGHT, TS_PAST,
                TS_NOW_PRESENT, TS_FUTURE}});
        mFiveSequences.put(CE_STRONG, new String[][]{{CE_STRONG, A_TOGETHER, A_ATTACK_WAR, A_TOGETHER,
                T_DESTINY}, {CE_STRONG, A_TOGETHER, A_ATTACK_WAR, A_TOGETHER, CE_CHAOS}});
        mFiveSequences.put(H_XM, new String[][]{{H_XM, CE_PATH, TS_FUTURE, T_DESTINY, CE_HARMONY_PEACE},
                {H_XM, A_CREATE, CE_COMPLEX, H_HUMAN, T_DESTINY}});
        mFiveSequences.put(H_PORTAL, new String[][]{{H_PORTAL, A_CREATE, CE_DANGER, A_PURSUE, CE_SAFETY},
                {H_PORTAL, CE_POTENTIAL, A_HELP, H_HUMAN, TS_FUTURE}, {H_PORTAL, CE_BARRIER, A_DEFEND,
                H_HUMAN, H_SHAPERS}, {H_PORTAL, FD_IMPROVE, H_HUMAN, TS_FUTURE, CE_CIVILIZATION}});
    }
    ...
    public List<Map<String, int[]>> getGlyphPairs() {
        if (mGlyphPairs == null) {
            initGlyphPairs();
        }
        List<Map<String, int[]>> pairs = new ArrayList<>();
        for (String[] strs : mGlyphPairs) {
            Map<String, int[]> pairContent = new HashMap<>();
            for (String str : strs) {
                pairContent.put(str, mBaseGlyphs.get(str));
            }
            pairs.add(pairContent);
        }
        return pairs;
    }
