...
public class BaseGlyphData {
    ...
    private static final String CE_DEATH = "Death";
    ...
    private void initGlyphCategories() {
        ...
        mCategoryGlyphs.put(C_HUMAN, new String[]{H_BODY_SHELL, H_ENLIGHTENMENT, H_BEING_HUMAN, H_MIND,
                H_RESISTANCE_STRUGGLE, H_PORTAL, H_INDIVIDUAL_SELF, H_COLLECTIVE_SHAPERS, H_SOUL_SPIRIT, H_XM,
                H_CREATIVITY, H_ENLIGHTENED, H_I_ME, H_RESIST, H_THEM, H_US_WE, H_OTHER_YOU_YOUR});

        mCategoryGlyphs.put(C_ACTION, new String[]{A_ADVANCE, A_ATTACK_WAR, A_AVOID, A_BREATHE_LIVE,
                A_CAPTURE, A_CHANGE_MODIFY, A_CREATE_CREATION, A_DEFEND, A_DESTROY_DESTRUCTION, A_DIE,
        ...
        mCategoryGlyphs.put(C_COND_ENV, new String[]{CE_ALL, CE_BALANCE_PERFECTION, CE_BARRIER_OBSTACLE,
                CE_CHAOS_DISORDER, CE_CIVILIZATION_CITY_GOVERNMENT_STRUCTURE, CE_CLEAR, CE_COMPLEX, CE_CONFLICT, CE_DANGER,
                CE_DIFFICULT, CE_EASY, CE_HARM, CE_HARMONY_PEACE, CE_HAVE, A_HELP, CE_IMPERFECT, CE_IMPURE,
                CE_NATURE, CE_PATH, CE_POTENTIAL, CE_PURE_PURITY, CE_SAFETY, CE_SIMPLE, CE_STABILITY_STAY,
                CE_STRONG, CE_WEAK, CE_ADAPT, CE_CONSEQUENCE, CE_NZEER, CE_UNBOUNDED, CE_DEATH});
        ...
        mCategoryGlyphs.put(C_NEW_ADDED, new String[]{A_ABANDON, TS_BEGIN, TS_DESTINATION, FD_LEGACY,
                ...
                T_TECHNOLOGY, H_THEM, CE_UNBOUNDED, FD_VICTORY, FD_WORTH, H_OTHER_YOU_YOUR, CE_DEATH});
    ...
    private void initThreeSequences() {
        ...
        mThreeSequences.put(A_INTERRUPT, new String[][]{
                {A_INTERRUPT, H_ENLIGHTENED, T_TECHNOLOGY}
        });
    ...
    private void initFourSequences() {
        ...
        mFourSequences.put(H_ENLIGHTENMENT, new String[][]{
                {H_ENLIGHTENED, A_CAPTURE, FD_VICTORY, A_TOGETHER}
        });
        mFourSequences.put(A_ESCAPE, new String[][]{
                {A_ESCAPE, CE_SIMPLE, H_BEING_HUMAN, TS_FUTURE},
                {A_ESCAPE, TS_BEFORE, CE_PURE_PURITY, CE_DEATH}
        });
        ...
        mFourSequences.put(A_HELP, new String[][]{
                ...
                {A_HELP, H_ENLIGHTENED, CE_STRONG, FD_VICTORY},
        ...
        mFourSequences.put(H_PORTAL, new String[][]{
                ...
                {H_PORTAL, A_DIE, CE_CIVILIZATION_CITY_GOVERNMENT_STRUCTURE, A_DIE},
        ...
        mFourSequences.put(H_SOUL_SPIRIT, new String[][]{
                {H_SOUL_SPIRIT, A_REBEL, H_BEING_HUMAN, A_DIE}
        });
...
//        });
        mFourSequences.put(H_XM, new String[][]{
                ...
                {H_XM, A_DIE, CE_CHAOS_DISORDER, A_BREATHE_LIVE},
                {H_XM, A_NOURISH, CE_STRONG, H_CREATIVITY}
        });
    }
    ...
    private void initFiveSequences() {
        ...
        mFiveSequences.put(CE_CLEAR, new String[][]{
                ...
                {CE_CLEAR, H_OTHER_YOU_YOUR, H_MIND, A_CREATE_CREATION, FD_GROW},
        ...
        mFiveSequences.put(A_ESCAPE, new String[][]{
                ...
                {A_ESCAPE, TS_BEFORE, CE_DEATH, TS_CLOSE_END_FINALITY, CE_ALL}
        });
        ...
        mFiveSequences.put(A_INTERRUPT, new String[][]{
                {A_INTERRUPT, H_ENLIGHTENED, T_TECHNOLOGY, A_CAPTURE, FD_VICTORY},
    ...
    private void initGlyphPairs() {
        mGlyphPairs = new String[][]{{FD_GAIN, FD_LOSE_LOSS}, {A_DESTROY_DESTRUCTION, A_CREATE_CREATION},
                {A_ADVANCE, A_RETREAT}, {TS_OLD, TS_NEW}, {A_BREATHE_LIVE, A_DIE}, {A_DEFEND, A_ATTACK_WAR},
                {A_PURSUE_ASPIRATION, T_WANT_DESIRE}, {CE_PATH, CE_BARRIER_OBSTACLE}, {T_COURAGE, T_FEAR},
                {CE_CIVILIZATION_CITY_GOVERNMENT_STRUCTURE, CE_NATURE}, {A_LIBERATE, A_CAPTURE}, {FD_LESS, FD_MORE},
                {H_MIND, H_SOUL_SPIRIT}, {T_FORGET, T_IGNORE}, {CE_PURE_PURITY, CE_IMPURE},
                {FD_EVOLUTION_PROGRESS_SUCCESS, FD_FAILURE}, {FD_DETERIORATE_ERODE, FD_IMPROVE}, {T_MESSAGE, T_DATA},
                {TS_PAST, TS_NOW_PRESENT, TS_FUTURE}, {CE_ALL, TS_CLOSE_CLEAR_ALL, TS_OPEN_ALL}};
    }
    ...
    @StringDef({H_BODY_SHELL, H_ENLIGHTENMENT, H_BEING_HUMAN, H_MIND, H_RESISTANCE_STRUGGLE, H_PORTAL,
            H_INDIVIDUAL_SELF, H_COLLECTIVE_SHAPERS, H_SOUL_SPIRIT, H_XM, A_ADVANCE, A_ATTACK_WAR, A_AVOID,
            A_BREATHE_LIVE, A_CAPTURE, A_CHANGE_MODIFY, A_CREATE_CREATION, A_DEFEND,
            A_DESTROY_DESTRUCTION, A_DIE, A_DISCOVER, A_ESCAPE, A_HIDE, A_JOURNEY, A_LIBERATE,
            ...
            FD_EVOLUTION_PROGRESS_SUCCESS, FD_FAILURE, FD_FOLLOW, FD_GAIN, FD_GROW, FD_IMPROVE, FD_LEAD, FD_LESS,
            FD_LOSE_LOSS, FD_MORE, FD_CONTRACT_REDUCE, TS_AGAIN_REPEAT, TS_CLOSE_CLEAR_ALL, TS_DISTANCE_OUTSIDE,
            TS_CLOSE_END_FINALITY, TS_FUTURE, TS_NEW, TS_INSIDE_NOT, TS_NOW_PRESENT, TS_OLD, TS_OPEN_ACCEPT,
            TS_OPEN_ALL, TS_PAST, CE_ALL, CE_BALANCE_PERFECTION, CE_BARRIER_OBSTACLE, CE_CHAOS_DISORDER,
            CE_CIVILIZATION_CITY_GOVERNMENT_STRUCTURE, CE_CLEAR, CE_COMPLEX, CE_CONFLICT, CE_DANGER, CE_DIFFICULT, CE_EASY,
            CE_HARM, CE_HARMONY_PEACE, CE_HAVE, A_HELP, CE_IMPERFECT, CE_IMPURE, CE_NATURE, CE_PATH,
            CE_POTENTIAL, CE_PURE_PURITY, CE_SAFETY, CE_SIMPLE, CE_STABILITY_STAY, CE_STRONG, CE_WEAK,
            A_ABANDON, TS_BEGIN, TS_DESTINATION, FD_LEGACY, CE_NZEER, T_KNOWLEDGE, T_PERSPECTIVE,
            H_US_WE, CE_ADAPT, TS_AFTER, TS_BEFORE, CE_CONSEQUENCE, H_CREATIVITY, H_ENLIGHTENED,
            H_I_ME, T_INTELLIGENCE, A_INTERRUPT, A_LIVE_AGAIN, T_MYSTERY, A_PRESENCE, A_CHASE, H_RESIST,
            A_SUSTAIN, A_SUSTAIN_ALL, T_TECHNOLOGY, H_THEM, CE_UNBOUNDED, FD_VICTORY, FD_WORTH,
            H_OTHER_YOU_YOUR, UNKNOWN_FISH, UNKNOWN_BOMB, UNKNOWN_PLOUGH, UNKNOWN_SOWN})
