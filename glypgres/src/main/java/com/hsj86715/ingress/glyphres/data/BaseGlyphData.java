...
public class BaseGlyphData {
    private static final String H_BODY = "Body";
    private static final String H_ENLIGHTENMENT = "Enlightenment";
    private static final String H_HUMAN = "Human";
    ...
    private static final String H_SELF = "Self";
    private static final String H_SHAPERS = "Shapers";
    private static final String H_SOUL = "Soul";
    ...
    private static final String A_CHANGE = "Change";
    private static final String A_CREATE = "Create";
    private static final String A_DEFEND = "Defend";
    private static final String A_DESTROY = "Destroy";
    ...
    private static final String A_PURSUE = "Pursue";
    ...
    private static final String A_SAVE = "Save";
    ...
    private static final String T_WANT = "Want";
    private static final String FD_DETERIORATE = "Deteriorate";
    private static final String FD_EQUAL = "Equal";
    private static final String FD_EVOLUTION_SUCCESS = "Evolution/Success";
    ...
    private static final String CE_BARRIER = "Barrier";
    private static final String CE_CHAOS = "Chaos";
    private static final String CE_CIVILIZATION = "Civilization";
    ...
    private static final String CE_PURE = "Pure";
